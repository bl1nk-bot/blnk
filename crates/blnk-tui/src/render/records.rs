...
use crate::render::line_utils::{line_to_static, push_owned_lines};
...
// TODO: TableColumnKind, TableColumnMetrics, TableCell, TABLE_BODY_SEPARATOR_CHAR
// These types are defined elsewhere in the full TUI codebase.
// Stubbed here for structure.
...
#[derive(Debug, Clone)]
pub(crate) struct TableColumnMetrics {
...
pub(crate) const TABLE_BODY_SEPARATOR_CHAR: char = '─';
